      ...
      <div className="container m-auto max-w-2xl">
        <div className="form-container">
          ...
          <div className="form-header">
            ...
            <h2 className="text-3xl font-extrabold text-white tracking-tight">Update Job</h2>
            <p className="text-indigo-200 mt-1 text-sm">Edit the details below and save your changes</p>
          </div>
