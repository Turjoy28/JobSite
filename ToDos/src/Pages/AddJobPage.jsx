      ...
      <div className="container m-auto max-w-2xl">
        <div className="form-container">
          ...
          <div className="form-header">
            ...
            <h2 className="text-3xl font-extrabold text-white tracking-tight">Add a New Job</h2>
            <p className="text-indigo-200 mt-1 text-sm">Fill in the details below to post your listing</p>
          </div>

          <form onSubmit={submitForm} className="form-body space-y-5">
            {/* Job Info */}
